...
export const projects: Project[] = [
  ...
  },
  {
    ...
    details: {
      ...
      features: [
        "User Authentication",
        "Email Verification Limit for Non-Signed User",
      ...
      challenges:
        "The main challenge in building the MSLMCloud Email Verification Landing Page was creating a visually appealing yet lightweight design that clearly communicated the product’s value. Ensuring responsiveness, fast load times, and clarity across all devices was critical.",
      outcome:
        "Delivered a clean, conversion-focused landing page that improved user experience, increased engagement, and reinforced the product’s credibility.",
